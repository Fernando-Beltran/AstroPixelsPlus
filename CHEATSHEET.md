...
## 2. PSI commands (Front / Rear / Both)

These are the always-on color-changing panels (Front PSI / Rear PSI). They are **not** the logic displays.
...
| Command | Description |
|---------|-------------|
| `@1P1` / `@2P1` / `@0P1` | PSI → Normal |
| `@1P2` / `@2P2` / `@0P2` | PSI → Flashing Color |
| `@1P3` / `@2P3` / `@0P3` | PSI → Alarm |
| `@1P4` / `@2P4` / `@0P4` | PSI → Failure |
| `@1P5` / `@2P5` / `@0P5` | PSI → Red Alert |
| `@1P6` / `@2P6` / `@0P6` | PSI → Leia |
| `@1P11` / `@2P11` / `@0P11` | PSI → March |
...
## 4. Low-level commands — HP protocol (holos)
