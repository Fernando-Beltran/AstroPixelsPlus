...
MARCDUINO_ACTION(FrontHoloOn, *ON01, ({
    // Front Holo Dim cycle HN color
    CommandEvent::process(F("HPF0040"));
    //CommandEvent::process(F("HPS301"));
...
MARCDUINO_ACTION(FrontHoloHN01Move, *RD01, ({
    // Front Holo Move HN01
    CommandEvent::process(F("HPF104"));
}))

////////////////

MARCDUINO_ACTION(RearHoloHN01Move, *RD02, ({
    // Rear Holo Move HN01
...
MARCDUINO_ACTION(TopHoloHN01Move, *RD03, ({
    // Top Holo Move HN01
...
MARCDUINO_ACTION(RadarEyePulse, *HRS3, ({
    // Radar Eye Dim pulse *HN01 color
...
MARCDUINO_ACTION(FrontHoloPulse, *HPS301, ({
    // Front Holo Dim pulse *HN01 color
